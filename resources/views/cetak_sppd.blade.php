...
//----------------------BUKTI KAS----------------------------//
    ...
    $pdf->Cell(34,4,'',0,0);
    $pdf->Cell(100,6,'DANA ALOKASI KHUSUS (DAK) FISIK TAHUN 2019',0,1,'L');
    }
 ...
 foreach ($tugas as $key) {
     foreach ($pegawai as $item) {
         if ($item->id == $key->id_pegawai) {
            ...
            $pdf->Line (50,$Y,190,$Y);
            $pdf->Cell(6,10,'1','TB',0,'C');
            $pdf->Cell(90,10,'Pejabat yang memberi perintah','RT',0,'L');
            $pdf->Cell(0,10,$kadis,'LTB',1,'L');
            $pdf->Cell(6,10,'2','TB',0,'C');
            $pdf->Cell(90,10,'Nama Pegawai yang diperintahkan','TBR',0,'L');
            $pdf->Cell(0,10,$item->nama,"TBL",1,'L');
            $pdf->Cell(6,10,'3','',0,'C');
            $pdf->Cell(90,10,'a. Pangkat / Golongan','TR',0,'L');
            $pdf->MultiCell(0,10,$item->pangkat,'',1);
            $pdf->Cell(6,10,'','','C');
            $pdf->Cell(90,10,'b. NIP','R',0,'L');
            $pdf->Cell(0,10,$item->nip,'',1,'L');
            $pdf->Cell(6,10,'','',0,'C');
            $pdf->Cell(90,10,'c. Jabatan','',0,'L');
            $pdf->MultiCell(0,10,$item->jabatan,'L',1,);
            $pdf->Cell(6,10,'4','TB',0,'C');
            $pdf->Cell(90,10,'Maksud perjalanan Dinas','TBR',0,'L');
            $pdf->MultiCell(0,10,$acara,"TB",1);
            $pdf->Cell(6,10,'5','TB',0,'C');
            $pdf->Cell(90,10,'Kendaraan yang dipergunakan','TBR',0,'L');
            $pdf->Cell(0,10,$kendaraan,'TBL',1,'L');
            $pdf->Cell(6,10,'6','T',0,'C');
            $pdf->Cell(90,10,'a. Tempat berangkat','TR',0,'L');
            $pdf->Cell(0,10,$tempat_berangkat,'T',1,'L');
            $pdf->Cell(6,10,'','B',0,'C');
            $pdf->Cell(90,10,'b. Tempat tujuan','B',0,'L');
            $pdf->MultiCell(0,10,$tempat_tujuan,'LB',1);
            $pdf->Cell(6,10,'7','T',0,'C');
            $pdf->Cell(90,10,'a. Lamanya perjalanan Dinas','TR',0,'L');
            $pdf->Cell(0,10,$lama.' (hari)','TL',1,'L');
            $pdf->Cell(6,10,'','',0,'C');
            $pdf->Cell(90,10,'b. Tanggal berangkat','R',0,'L');
            $pdf->Cell(0,10,$berangkat,'0',1,'L');
            $pdf->Cell(6,10,'','0',0,'C');
            $pdf->Cell(90,10,'c. Tanggal kembali','R',0,'L');
            $pdf->Cell(0,10,$kembali,'',1,'L');
            $pdf->Cell(6,10,'8','T',0,'C');
            $pdf->Cell(90,10,'Pemberi anggaran','T','L');
            $pdf->Cell(0,10,$anggaran.' '.$tahun_anggaran,'TL',1,'L');
            $pdf->Cell(6,10,'','0',0,'C');
            $pdf->Cell(90,10,'a. Instansi','R',0,'L');
            $pdf->Cell(0,10,'a. Dinas Pariwisata Kab. Bantul','0',1,'L');
            $pdf->Cell(6,10,'','0',0,'C');
            $pdf->Cell(90,10,'b. Mata Anggaran','R',0,'L');
            $pdf->Cell(0,10,'b. -','0',1,'L');
            $pdf->Cell(6,10,'9','TB',0,'C');
            $pdf->Cell(90,10,'Keterangan lain-lain','TB',0,'L');
            $pdf->Cell(0,10,'','LTB',1,'L');
            $pdf->Cell('',5,'',0,1,'C');
            $pdf->Cell(100,5,'',0,0);
